...
class Exam(models.Model):
    ...
    batch = models.ForeignKey("Batch", blank=True, on_delete=models.CASCADE, null=True)
...
class Batch(models.Model):
    ...
    status = models.BooleanField(default=True, null=True, blank=True) # isActive or not
